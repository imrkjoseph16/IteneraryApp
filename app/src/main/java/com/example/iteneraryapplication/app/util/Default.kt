...
class Default {
    companion object {
        ...
        const val DB_TRAVEL_ITINERARY_PATH = "itineraryapp.db"
        const val DB_TRAVEL_PLANNING_TABLE = "travelplanning"
        const val DB_TRAVEL_PLANNING_TITLE = "title"
        const val DB_TRAVEL_PLANNING_DESC = "description"
